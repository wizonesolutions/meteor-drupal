Right now, this adds a Meteor method that lets you create a new Meteor account by email. The [Drupal module](https://github.com/wizonesolutions/drupal-meteor-signup) uses this method to create new accounts.
